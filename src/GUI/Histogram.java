...
public class Histogram {
    ...
    public static LineChart<String, Number> createHistogram(String[] labels, int[] data){
        final LineChart<String, Number> chartHistogram = new LineChart<>(new CategoryAxis(), new NumberAxis());
